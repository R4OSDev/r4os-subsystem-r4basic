...
pub const unsupported_keyword_words = [_][]const u8{
    ...
    "CALLS",    "CDECL",    "CHAIN",  "CHDIR",    "CHDRIVE",  "CLEAR",  "COM",
    "COMMAND$", "COMMON",   "CSRLIN", "DATE$",    "DEFDBL",   "DEFLNG", "DEFSNG",
    "DEFSTR",   "DRAW",     "ENDIF",  "ENVIRON",  "ENVIRON$", "ERASE",  "ERDEV",
    "ERDEV$",   "ERR",      "FIELD",  "FILEATTR", "FILES",    "FRE",    "FREEFILE",
    "HEX$",     "INP",      "INPUT$", "IOCTL",    "IOCTL$",   "IS",     "KEY",
    "KILL",     "LBOUND",   "LCASE$", "LIST",     "LOAD",     "LOCAL",  "LOC",
    "LOCK",     "LOF",      "LPOS",   "LPRINT",   "LSET",     "MKDIR",  "NAME",
    "OCT$",     "OFF",      "OPTION", "OUT",      "PCOPY",    "PEN",    "PMAP",
    "POS",      "PRESERVE", "PRESET", "RANDOM",   "RESET",    "RIGHT$", "RMDIR",
    "RSET",     "RTRIM$",   "RUN",    "SADD",     "SAVE",     "SEEK",   "SETMEM",
    "SHELL",    "SIGNAL",   "SOUND",  "SPC",      "STICK",    "STOP",   "STRIG",
    "STRING$",  "SWAP",     "SYSTEM", "TIME$",    "TROFF",    "TRON",   "UBOUND",
    "UEVENT",   "UNLOCK",   "USING",  "VARPTR",   "VARPTR$",  "VARSEG", "WAIT",
    "WINDOW",   "WRITE",
};
