...
pub const unsupported_keyword_words = [_][]const u8{
    "ACCESS", "ALIAS",    "BASE",     "BINARY",  "BLOAD",    "BSAVE",  "CALLS",
    "CDECL",  "CHAIN",    "CHDIR",    "CHDRIVE", "CLEAR",    "COM",    "COMMAND$",
    "COMMON", "DATE$",    "DEFDBL",   "DEFLNG",  "DEFSNG",   "DEFSTR", "DRAW",
    "ENDIF",  "ENVIRON",  "ENVIRON$", "ERASE",   "ERDEV",    "ERDEV$", "ERR",
    "FIELD",  "FILEATTR", "FILES",    "FRE",     "FREEFILE", "INP",    "IOCTL",
    "IOCTL$", "IS",       "KEY",      "KILL",    "LBOUND",   "LIST",   "LOAD",
    "LOCAL",  "LOC",      "LOCK",     "LOF",     "LPOS",     "LPRINT", "LSET",
    "MKDIR",  "NAME",     "OFF",      "OPTION",  "OUT",      "PCOPY",  "PEN",
    "PMAP",   "PRESERVE", "PRESET",   "RANDOM",  "RESET",    "RMDIR",  "RSET",
    "RUN",    "SADD",     "SAVE",     "SEEK",    "SETMEM",   "SHELL",  "SIGNAL",
    "SOUND",  "STICK",    "STOP",     "STRIG",   "SWAP",     "SYSTEM", "TIME$",
    "TROFF",  "TRON",     "UBOUND",   "UEVENT",  "UNLOCK",   "VARPTR", "VARPTR$",
    "VARSEG", "WAIT",     "WINDOW",
};
